{
    ...
    'data': [
        ...
        'views/snippets/index/video_tabs_templates.xml',
        'views/snippets/index/image_tabs_templates.xml',
        'views/snippets/index/image_infinite_carousel_templates.xml',
    ...
    'assets': {
        ...
        'web.assets_frontend': [
            ...
            'theme_darko/static/src/js/video_control.js',
            'theme_darko/static/src/js/video_tabs.js',
            'theme_darko/static/src/js/image_tabs.js',
            'theme_darko/static/src/js/image_infinite_carousel.js',
            'theme_darko/static/src/js/navbar_background.js',
            'theme_darko/static/src/js/navbar_background.js',
            'theme_darko/static/src/js/sticky_feature_img.js',
            'theme_darko/static/src/js/EditModeDetector.js',
        ],
    },
    'images': [
