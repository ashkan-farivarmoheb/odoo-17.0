...
class WebsiteProduct(http.Controller):
    ...
    def get_featured_products(self):
        ...
        darko_configuration = request.env.ref(
            'theme_darko.darko_configuration_data')
        product_id = darko_configuration.featured_product_ids
        ...
        response = http.Response(
            template='theme_darko.featured_product_snippet', qcontext=values)
    ...
    def get_popular_products(self):
        ...
        response = http.Response(
            template='theme_darko.popular_snippet', qcontext=values)
        return response.render()
    ...
    def get_trending_product(self):
        ...
        response = http.Response(
            template='theme_darko.trending_snippet', qcontext=values)
        return response.render()
