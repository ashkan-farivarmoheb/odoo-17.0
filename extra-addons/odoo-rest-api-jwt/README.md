...
Before initiating any requests, ensure that you are authenticated through the `restful_api_jwt` add-on by using the SignIn endpoint to obtain an "access_token".
