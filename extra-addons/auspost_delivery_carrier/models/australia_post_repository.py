...
def get_config_variable(key):
    ...
    if not value:
        raise UserError(_("The configuration variable '%s' is not set.") % key)
    return value


host = get_config_variable("services_austpost_endpoint")
shipment_price_path = get_config_variable("services_austpost_shipmentprice_path")
account_details_path = get_config_variable("services_austpost_accountdetails_path")
create_shipment_path = get_config_variable("services_austpost_createshipment_path")
create_order_path = get_config_variable("services_austpost_createorder_path")
service_rate_path = get_config_variable("services_austpost_servicerate_path")
item_prices_path = get_config_variable("services_austpost_get_item_prices_path")
delete_shipment_path = get_config_variable("services_austpost_delete_shipment_path")
delete_item_path = get_config_variable("services_austpost_delete_item_path")
create_label_path = get_config_variable("services_austpost_createlabel_path")
